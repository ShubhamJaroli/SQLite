...
import { Animated, EasingFunction, StyleProp, TextStyle, ViewStyle, LayoutChangeEvent } from 'react-native';
import { EdgeInsets } from 'react-native-safe-area-context';
import { NavigationRoute, NavigationState, NavigationScreenProp, NavigationProp, NavigationParams, NavigationNavigateAction, NavigationAction, NavigationEventCallback, NavigationEventSubscription, NavigationDescriptor } from 'react-navigation';
export declare type Route<T extends string> = NavigationRoute;
...
export declare type StackNavigationHelpers = NavigationProp<NavigationStackState>;
export declare type StackNavigationProp<State = NavigationRoute, Params = NavigationParams> = NavigationScreenProp<State, Params> & {
...
export declare type StackDescriptor = NavigationDescriptor<NavigationParams, StackNavigationOptions, StackNavigationProp>;
export declare type StackDescriptorMap = {
    [key: string]: StackDescriptor;
};
export declare type TransitionCallbackProps = {
    closing: boolean;
};
